<template>
  <div class="page-full">
    <h2>Basic Usage</h2>
    <ParallaxBackground :backgroundImage="'https://picsum.photos/1920/1080'" :speed="2" direction="down"
    ...
    <ParallaxBackground :backgroundImage="'https://picsum.photos/1920/1080'" :speed="3" direction="up"
